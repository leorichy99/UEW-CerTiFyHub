...
const PERMISSION_DESCRIPTIONS = {
  ...
  "students.view": "Read-only access to student data linked to certificates.",
  "students.edit": "Modify student data. High privilege — confirm letter scope before enabling.",
  "students.import": "Bulk import student records. Very high privilege — must be explicitly stated in the letter scope.",
